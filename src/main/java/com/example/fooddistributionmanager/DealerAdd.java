...
public class DealerAdd implements Initializable {
    ...
    private void getUserInfo() {
        dealer = new Dealer();
        dealer.setName(newName.getText());
        dealer.setPhone(newPhone.getText());
        dealer.setId(newId.getText());
        dealer.setDivision(newDivisionChoice.getValue());
        list.add(dealer);
    }
